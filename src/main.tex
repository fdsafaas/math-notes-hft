...
\part {Combinatorics}
\part {Probability}
\include{probability_models}
\include{random_variable}
\include{general_random_variables}
\include{advanced_topics_random_variable}
\include{bernoulli_poisson}
\include{markov_chains}
\part {Geometry}
\part {Linear Algebra}
